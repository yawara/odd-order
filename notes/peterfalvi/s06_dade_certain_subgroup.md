...
2. **(3.4) α_ij basis** of CF(W,V), V=W−(W₁∪W₂)。α_ij=(1−ω_i0)(1−ω_0j)、dim=(w₁−1)(w₂−1)。線形独立 + 次元一致。**dim 完成 + lin-indep foundations (session 10 cont.); 残 = Fourier coeff (iii) + index count (iv) + basis 組立 (v)。**
