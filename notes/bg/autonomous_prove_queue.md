...
| 9 | **Lem 4.13/4.14** q∣\|Aut R\|⇒q∣p²-1, q<p | — | gate: #3 GL橋✅ + SCN₃=∅✅。⚠BG証明="Lem4.7 and **G** Thm5.4.15" = Gorenstein行間 | **NEXT** (Thm4.16 唯一残ゲート; design 段で G5.4.15/Lem4.7⇐ 要否を assess, 重ければ Lem4.7⇐=G5.4.15 を先行 target 化 — §5 とも共有ゲート) |
