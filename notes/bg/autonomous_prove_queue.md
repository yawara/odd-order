...
| 8.7 | **precursor(1)** `pRank_le_two_of_scn3_empty` (=G Thm4.15(i)) | `pRank_le_two_of_scn3_empty` | gate: 8.6✅ + GL橋✅。**§5 も開く** | **NEXT** (frontier; SCN₃=∅⇒pRank≤2, S04:1036 にゲート明記; 独立 leaf 推奨) |
