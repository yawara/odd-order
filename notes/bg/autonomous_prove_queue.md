...
| 8.5 | **G Lem 4.12 + 4.13** (Lemma4.14 前提, 新規小) | `proper_closure_conj_of_not_isCyclic` ほか | gate無 (Frattini/commutator 既存) | **NEXT** (Gorenstein chain 最下層, bundle) |
| 8.6 | **G Lemma 4.14** Ω₁(C_P(Ω₁(A)))=Ω₁(A) | — | gate: 8.5 + 3.9(i)✅/3.12✅/1.3.4✅ | queued (大 engine, 8.5 後) |
| 8.7 | **precursor(1)** `pRank_le_two_of_scn3_empty` (=G Thm4.15(i)) | `pRank_le_two_of_scn3_empty` | gate: 8.6 + GL橋✅。**§5 も開く** | queued (独立 leaf 推奨) |
