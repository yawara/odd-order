...
|---|---|---|---|---|
| 1 | **Thm 4.12(a)** metacyclic+[R,A]=R⇒abelian | `isMulCommutative_of_metacyclic_actionCommutator_eq_top` | a-2✅ N-4✅ Lem4.10✅ LEAF-4✅ LEAF-1✅ Lem4.1✅ | **IN PROGRESS** wf_7fe38a32-c2e |
| 2 | **Thm 4.12(b)(c)** T∩C=1, T/C cyclic, R'⊆T | `thm412bc_structure` 等 | (a)✅後 + Prop1.6(d) `fixedPoints_inf_actionCommutator_eq_bot_of_abelian` + Lem4.10✅ LEAF-4✅ | queued (gate: #1) |
| 3 | **I-0d GL橋** Aut(Eₚⁿ)≅GL(n,p) | `mulAutEquivGL` 等 + `card` 補題 | gate無 (mathlib `Matrix.card_GL_field`, `IsElementaryAbelian.zmodModule`) | queued (独立) |
