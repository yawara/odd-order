...
| 8 | **Prop 4.11 (Huppert)** p>3,\|Ω₁\|≤p²⇒metacyclic | `isMetacyclic_of_omega1_card_le_prime_sq` | **Lem4.9✅ + agemo✅ + Lem4.5(b)✅ + Lem4.2✅ + Lem4.1✅**。design §3 に full skeleton (8 step)。逐次分解で landing 中 | **IN PROGRESS** — base✅(f637e7f) + (4.7)lift✅(be039f2 `exists_metacyclic_lift_of_isMetacyclic_quotient_center_prime`) + step8✅(630cd73 `isMetacyclic_of_isCyclic_commutator_of_card_omega1_le`, R'cyclic⇒metacyclic, Odd p 一般化)。次=**main本体** `isMetacyclic_of_omega1_card_le_prime_sq` (|R|帰納: 2 helper + Lem4.9/Lem4.2/Lem4.1=commutative_of_cyclic_center_quotient/agemo を組む; 帰納 template = Lem4.9@S04:2671 の Nat.strongRecOn motive 形)。§4第2の山, Thm4.16 CaseA を開く |
