...
§4A **完全完成** (2026-05-23): Lem 4.1, 4.3, 4.4, **4.5 backward**, **4.6 前半+後半**, **Thm 4.7 (m=0 不可能 + m=1 base + m≥2 induction)**, **Thm 4.8(a)(b) + collection formula**. 残: Lem 4.5 forward (構造定理経由, 下流引用無し, 保留).
