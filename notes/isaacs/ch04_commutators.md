...
§4A **大部分完成** (Lem 4.1, 4.3, 4.4, **4.6 前半+後半**, **Thm 4.8(a)(b) + collection formula**). 残: Lem 4.5 (Frattini 経由 ~150 LOC), Thm 4.7 (maximal class p-群 ~150 LOC, Lem 4.6 後半完成で前提整備済み + Thm 1.19 経由).
