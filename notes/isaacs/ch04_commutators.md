...
| Thm 4.7 (maximal class) | docstring | Lem 4.6 後半 cardinality + Thm 1.19 (P' ∩ Z(P) 非自明 ← nilpotent) + 帰納 経由. ~100-150 LOC. Ch.10 で 2 引用. |
...
§4A **大部分完成** (Lem 4.1, 4.3, 4.4, **4.5 backward**, **4.6 前半+後半**, **Thm 4.8(a)(b) + collection formula**). 残: Thm 4.7 (maximal class p-群 ~150 LOC, Lem 4.6 後半完成で前提整備済み + Thm 1.19 経由), Lem 4.5 forward (構造定理経由, 下流引用無し).
