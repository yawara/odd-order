...
| Thm 4.7 m ≥ 2 induction | docstring | Thm 1.19 (`IsPGroup.normal_inf_center_nontrivial`, Ch.1 既存) + Lem 4.6 cardinality + 商 P/Z で IH 適用. 典型的 induction structure (induction m generalizing P) を typeclass implicit args 込みで書く工夫が必要. ~150 LOC. Ch.10 で 2 引用. |
...
§4A **大部分完成** (Lem 4.1, 4.3, 4.4, **4.5 backward**, **4.6 前半+後半**, **Thm 4.7 m=1 base + lcs map helper**, **Thm 4.8(a)(b) + collection formula**). 残: Thm 4.7 m ≥ 2 induction (~150 LOC), Lem 4.5 forward (構造定理経由, 下流引用無し).
