...
| § | 内容 | Isaacs 番号 | 進捗 |
|---|---|---|---|
| 1A | 群作用と Fundamental Counting Principle | Thm 1.1–1.6 (6 件) | 1.1, 1.4 ✅ / 1.2, 1.3, 1.5, 1.6 TODO |
| 1B | Sylow E, Cauchy | Thm 1.7–1.10 (4 件) | 1.7, 1.8, 1.9, 1.10 ✅ |
| 1C | Sylow C / D, Frattini argument | Thm 1.11–1.18 (8 件) | TODO |
| 1D | 冪零群, Fitting 部分群 `F(G)` | Thm 1.19–1.29 (11 件) | 設計ノートあり ([`ch01_sylow_d_fitting.md`](ch01_sylow_d_fitting.md)) |
