...
## ✅ 決着 (2026-07-27 22:4x) — ユーザー指示で 2 セッションとも kill

hub が worktree の cwd でプロセスを特定し、**両方を終了**した:

| PID | cwd | 状態 |
|---|---|---|
| 2732235 | `/home/ywr/odd-order-a` | 終了 |
| 2923188 | `/home/ywr/odd-order-a` | 終了 |

kill 前に確認: **未マージ commit 0 / 子プロセス無し / 未追跡ファイル 1 本のみ**
