...
を sorry-free で追加。残りは source 側 `‖Ind 1_H - ζ‖² = e+1` の character computation と、
...
| (7.10) | 上記の合成 + 算術操作 | ⬜ sorry (S09:2684) |
