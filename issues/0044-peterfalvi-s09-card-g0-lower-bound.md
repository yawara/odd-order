...
`0 ≤ u a² - 2 v a` を出す補題で、残りの blocker は `‖β‖²=e+1` と
...
| (7.10) | 上記の合成 + 算術操作 | ⬜ sorry (S09:2658) |
