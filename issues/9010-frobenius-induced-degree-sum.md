...
- [ ] 新 shared leaf `OddOrder/GroupTheory/RepresentationTheory/InducedDegreeSum.lean`:
      ...
      = issue 9007 の罠は該当せず)。
- [ ] consumer = lane c の S16 (14.14) pairing-bounds 組立 (別 leaf、c 所有)。

## 完了条件

leaf が sorry-free で `lake build` green、S16 側が cite。
