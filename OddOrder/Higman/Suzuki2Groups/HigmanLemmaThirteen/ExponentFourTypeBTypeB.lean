...
/-!
# Higman's Lemma 13: the exponent-four type-B/type-B branch

G. Higman, “Suzuki 2-groups,” *Illinois Journal of Mathematics* 7 (1963),
Lemma 13, p. 92.

This file closes the branch in which the normalized right factors of two
restricted length-three Frattini covers are both of type B.  Their canonical
...
/-- **Higman Lemma 13 (p. 92), exponent-four B/B contradiction.**

Two restricted Frattini covers whose normalized right factors both have
trivial semilinear part cannot generate the ambient group. -/
theorem false_of_two_typeB_sharpRestrictedFactorPairs_of_exponent_four
  ...
  have hXZ : ⁅X, Z⁆ ≤ frattiniSquare P :=
    commutator_le_frattiniSquare_of_restricted_typeB_factors
      ...
      hZinv hEAZ hMapZ hxiZ hinvPhiZ eZ heZ hconjZ
      factorsZ leftZ rightZ hleftZ hleftThetaZ hrightThetaZ
