...
`sorry` and reserved for follow-on issues (see `issues/0045-*`). -/
...
`aH(a)`.  Consequence of (7.2.b); see `issues/0045-*` follow-on. -/
...
`CF(G)`).  See `issues/0045-peterfalvi-s09-rho-and-7-1-7-3.md`. -/
