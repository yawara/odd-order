...
- 6A
  - 内容: Frobenius action の定義と equivalences
  - Isaacs 番号: 6.1 – 6.7
  - 状態: ✅ (6.7 = `KernelComplement`)
- 6B
  - 内容: Frobenius complement Sylow 構造
  - Isaacs 番号: 6.8 – 6.21
  - 状態: ✅ (6.8 = `FrobeniusActionTI`, 6.19 = `OddComplement`)
- 6C
  - 内容: Frobenius kernel nilpotent + Thompson
  - Isaacs 番号: 6.22 – 6.24
  - 状態: ✅ (6.22 = BG Thm 3.7 経由, 6.23 = `ThompsonPComplement`,
      6.24 = `KernelNilpotent`)
