...
/-!
# BG §16 — Proposition 16.1: the local taxonomy predicates

The shared Type I–V predicates and the Proposition 16.1 taxonomy layer consumed by
the Theorem I/II output file.
