...
/-!
# BG §16 — Proposition 16.1 forward bridges: the shared type data

Construction of the shared `TypePData` / type-`F` bridges from the §14/§15 structure,
through `isTypeF_derivedInG_of_isTypeP2` and the conditional
`isTypeII_of_isTypeP2_of_derived_typeF`.

Split from the parent file (issue 0149, the longFile-1500 campaign); the parent imports
