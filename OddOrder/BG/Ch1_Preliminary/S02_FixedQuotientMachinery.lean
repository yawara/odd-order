...
/-!
# BG §2F — fixed submodules and quotients: the main layer

The `fixedOnSubmoduleAndQuotientSubgroup` machinery of the Theorem 2.6 proof:
scalar characters, determinant-kernel line analysis, the stay-or-swap dichotomy and
the commutator bounds, up to (but not including) the final assembly layer.
