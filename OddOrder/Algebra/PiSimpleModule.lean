...
acts as the identity** (and the others act as zero).  This is the general statement
`OddOrder.exists_unique_smul_eq_self_of_completeOrthogonal` for the coordinate idempotents. -/
